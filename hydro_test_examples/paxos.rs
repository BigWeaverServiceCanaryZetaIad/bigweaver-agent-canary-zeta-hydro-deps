// NOTE: This example requires the paxos_bench module which has been moved to the
// bigweaver-agent-canary-zeta-hydro-deps repository. To run benchmarks, please use
// the benchmarks repository. See README.md for more information.
