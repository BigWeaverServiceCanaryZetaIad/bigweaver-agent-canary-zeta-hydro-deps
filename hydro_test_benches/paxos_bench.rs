...
mod tests {
    ...
    fn create_paxos<'a>(
        proposers: &hydro_lang::location::Cluster<'a, crate::paxos::Proposer>,
        acceptors: &hydro_lang::location::Cluster<'a, crate::paxos::Acceptor>,
        clients: &hydro_lang::location::Cluster<'a, super::Client>,
        client_aggregator: &hydro_lang::location::Process<'a, super::Aggregator>,
        replicas: &hydro_lang::location::Cluster<'a, crate::kv_replica::Replica>,
    ) {
        super::paxos_bench(
            100,
            1000,
