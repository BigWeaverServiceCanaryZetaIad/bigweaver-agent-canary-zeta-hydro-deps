...
fn benchmark_dfir_rs_scheduled(c: &mut Criterion) {
...
fn benchmark_dfir_rs_surface(c: &mut Criterion) {
...
// fn benchmark_dfir_rs_teer(c: &mut Criterion) {
//     c.bench_function("fan_out/dfir_rs/teer", |b| {
//         b.iter(|| {
...
criterion_group!(
    fan_out_dataflow,
    benchmark_dfir_rs_scheduled,
    benchmark_dfir_rs_surface,
    // benchmark_dfir_rs_teer,
    benchmark_timely,
    benchmark_sol,
);
