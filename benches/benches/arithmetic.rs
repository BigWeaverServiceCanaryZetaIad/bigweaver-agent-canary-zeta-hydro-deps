// NOTE: This file has been adapted for the deps repository.
// Benchmarks requiring dfir_rs have been commented out.
// Only timely/differential-dataflow benchmarks are active.

use std::sync::mpsc::channel;
use std::thread;

use criterion::{Criterion, black_box, criterion_group, criterion_main};
// Note: dfir_rs dependency removed for standalone deps repository
...
criterion_group!(
    ...
    benchmark_raw_copy,
    // Note: dfir_rs benchmarks removed for standalone deps repository
