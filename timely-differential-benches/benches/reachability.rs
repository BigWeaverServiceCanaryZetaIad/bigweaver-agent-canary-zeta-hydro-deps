...
/// Benchmark for timely-dataflow's graph reachability computation.
/// This benchmark computes all nodes reachable from a starting node using iterative dataflow.
