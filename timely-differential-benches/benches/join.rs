...
fn benchmark_usize_usize(c: &mut Criterion) {
    benchmark_timely::<usize, usize>(c);
}

fn benchmark_string_string(c: &mut Criterion) {
    benchmark_timely::<String, String>(c);
}

criterion_group!(
    join_dataflow,
    benchmark_usize_usize,
    benchmark_string_string,
);
